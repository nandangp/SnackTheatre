    ...
    <center style="padding: 25px;">
     <a style="font-size: 15px; color: #1e1e1e; font-family: arial; text-decoration: none;">HI! You are not logged in</a> <br/>
        ...
        <div class="form-style-5">
			...
			<legend><span class="number"></span> Select Your Snack & Quantity</legend>
                        <h4 class="note">( Note: Only one item can be Selected )</h4>
                                                      <br>
			...
			<select required id="job" name="type" size="1">
                                                            ...
                                                            <option value="hamburger">Hamburger   |    Price: 150 Rs</option>
                                                            <option value="cheeseburger">Cheeseburger   |    Price: 200 Rs</option>
                                                            <option value="doublecheeseburger">Double Cheeseburger   |    Price: 250 Rs</option>
                                                            
                                                            <optgroup label="Coffee">
                                                            <option value="coldcoffee">cold coffee   |    Price: 100 Rs</option>
                                                            <option value="cappuccinocoffee">Cappuccino coffee   |    Price: 150 Rs</option>
                                                            <option value="blackcoffee">Black Coffee   |    Price: 120 Rs</option>
                                                            
                                                            <optgroup label="Cool Drinks">
                                                            <option value="pepsi">Pepsi   |    Price: 80 Rs</option>
                                                            <option value="cocaCola">Coca Cola   |    Price: 70 Rs</option>
                                                            <option value="sprite">Sprite   |    Price: 60 Rs</option>
