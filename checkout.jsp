...
<ul>
 ...
 if (tp.equals("hamburger"))
  { 
     ...
     price = 250* pr;
  }else if(tp.equals("coldcoffee")){
       price = 100* pr;
 }
 else if(tp.equals("cappuccinocoffee")){
       price = 150* pr;
 }else if(tp.equals("blackcoffee")){
       price = 120* pr;
 }else if(tp.equals("pepsi")){
       price = 80* pr;
 }else if(tp.equals("cocaCola")){
       price = 70* pr;
 }else if(tp.equals("sprite")){
       price = 60* pr;
 }else{
       price=1*price;
   }
        ...
        <div class="form-style-5">
			...
			<input type="text" name="lname" placeholder="Last Name *" required>
                                                     ...
                                                     <select required id="job" name="area" size="1">
                                                            ...
                                                            <option value="Kamakya">Kamakya</option>
                                                            <option value="Navarang">Navarang</option>
			...
			<input type="number" name="zipcode" value="" required placeholder="Seat No. *">
			 <input type="number" name="phone" value="" required placeholder="Phone Number *">
		                   <input type="date" name="ddate" placeholder="order Date *" required>
                                                       <input type="time" name="dtime" placeholder="order Time *" required>
