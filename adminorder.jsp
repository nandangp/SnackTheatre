...
<button onclick="myFunction()" class="dropbtn">Orders</button>
  <div id="myDropdown" class="dropdown-content">
	...
	<a href="adminorderc.jsp">out of stock</a>
  </div>
...
<div class="dashtext">Bill Details </div>
...
Update Order Id: &nbsp <%=resultSet.getString("oid") %>&nbsp
                ...
                <select required  name="orderstatus" size="1">
                                                   ...
                                                   <option value="out of stock">Mark as Cancelled</option>
...
<div class="logog"><a href="index.jsp" > <img src="img/logo.png"></a> </div>
