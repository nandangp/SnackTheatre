...
Class.forName("com.mysql.jdbc.Driver");
   ...
   try{
    ...
    //ResultSet rs;
    int i = st.executeUpdate("insert into orders(oid,item,fname,lname,area,city,zipcode,phone,ddate,dtime,quantity,price,email,orderstatus,orderdate)values(null,'"+item+"','"+fname+"','"+lname+"','"+area+"','"+city+"','"+zipcode+"','"+phone+"','"+ddate+"','"+dtime+"','"+quantity+"','"+price+"','"+email+"','"+orderstatus+"','"+orderdate+"')");
    if (i > 0) {
